...
RSpec.describe ALevelsWizard::StateStores::ALevel do
  ...
  describe "#subject" do
    let(:repository) { instance_double(ALevelsWizard::Repositories::ALevelSubjectRemoval, record: course, uuid: "abc123") }
