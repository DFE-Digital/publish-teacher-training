...
feature "Course show" do
  context "published course" do
    ...
    context "when cycle is 2025 and the course is published" do
      scenario "i can see the correct change links", travel: Find::CycleTimetable.mid_cycle(2025) do
    ...
    context "when it is during the 2026 schools migration" do
      scenario "i can see the correct change links", travel: Find::CycleTimetable.find_closes(2025) do
        find_or_create(:recruitment_cycle, year: 2025)
        allow(Settings).to receive(:current_recruitment_cycle_year).and_return(2025)
    ...
    context "when rollover after 2025 and schools are validated" do
      scenario "i can see the correct change links", travel: Find::CycleTimetable.find_closes(2026) do
