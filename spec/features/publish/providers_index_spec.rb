...
feature "Providers index" do
  ...
  scenario "view page as Mary - multi provider user", travel: Find::CycleTimetable.mid_cycle do
  ...
  scenario "view page as Colin - admin user", travel: Find::CycleTimetable.mid_cycle do
    given_we_are_not_in_rollover
  ...
  scenario "view page as Colin - admin user - during rollover", travel: Find::CycleTimetable.find_opens do
