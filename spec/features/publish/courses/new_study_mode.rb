...
private
  ...
  def selected_params(study_mode)
    "?course%5Bage_range_in_years%5D=%5B%223_to_7%22%5D&course%5Bis_send%5D=%5B%220%22%5D&course%5Blevel%5D=primary&course%5Bstudy_mode%5D=#{study_mode}&course%5Bsubjects%5D%5B%5D=2"
  end
end
