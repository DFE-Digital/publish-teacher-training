...
feature 'selecting an age range', { can_edit_current_and_next_cycles: false } do
  ...
  def when_i_select_a_custom_age_range
    publish_courses_age_range_edit_page.age_range_other.click
    publish_courses_age_range_edit_page.age_range_from_field.set('10')
    publish_courses_age_range_edit_page.age_range_to_field.set('15')
  end

  def when_i_select_an_invalid_age_range
    publish_courses_age_range_edit_page.age_range_other.click
    publish_courses_age_range_edit_page.age_range_from_field.set('10')
    publish_courses_age_range_edit_page.age_range_to_field.set('5')
  end
  ...
  def then_i_should_see_an_error_message
    expect(publish_courses_age_range_edit_page.error_messages).to include(
