...
feature "Adding a course with hide_applications_open_date active" do
  ...
  scenario "do not show application open date when creating a course" do
    given_i_am_authenticated_as_a_school_direct_provider_user
    when_i_visit_the_courses_page
    and_i_click_on_add_course
    and_i_choose_a_secondary_course
    ...
    # We skip the applications open date page
    then_i_am_on_the_add_applications_course_start_date_page
    and_the_back_link_points_to_the_study_site_page
  end
  ...
  def then_i_am_on_the_add_applications_course_start_date_page
  ...
  def and_i_add_what_you_will_study_details
    click_link_or_button "Change details about what you will study"
  ...
  def and_i_add_where_you_will_train_details
    click_link_or_button "Change where you will train"
  ...
  def and_i_add_what_will_you_will_do_on_placements
    click_link_or_button "Change what you will do on school placements"
