...
feature 'selecting an age range', { can_edit_current_and_next_cycles: false } do
  ...
  scenario 'selecting an age range' do
    when_i_visit_the_publish_courses_new_age_range_page
  ...
  def when_i_select_an_age_range
    publish_courses_new_age_range_page.age_range_fields.three_to_eleven.click
  end

  def when_i_select_another_age_range
    publish_courses_new_age_range_page.age_range_other.click
  end

  def and_fill_out_custom_values
    publish_courses_new_age_range_page.age_range_from_field.set('6')
    publish_courses_new_age_range_page.age_range_to_field.set('12')
  end
  ...
  def selected_params(age_range)
    "?course%5Bage_range_in_years%5D=#{age_range}&course%5Bis_send%5D=0&course%5Blevel%5D=primary&course%5Bsubjects_ids%5D%5B%5D=2"
  end
end
