...
feature "Why Train With Us section" do
  ...
  def then_i_can_edit_info_about_training_with_us
    ...
    expect(page).to have_current_path edit_publish_provider_recruitment_cycle_train_with_us_path(
      provider_code: @provider.provider_code,
      recruitment_cycle_year: @provider.recruitment_cycle_year,
    )
    ...
    within publish_provider_details_edit_page.error_summary do
      expect(page).to have_content "Enter details about your organisation"
    end
