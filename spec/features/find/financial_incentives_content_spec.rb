    ...
    context "given the course is salaried" do
      scenario "renders the salaried content for QTS with PGCE" do
        ...
        within('[data-qa="course__salary_details"]') do
          expect(page).to have_content("You will receive an unqualified teacher’s salary while training. The exact amount will vary depending on your school. You may also have to pay for your PGCE. You can discuss salary details with your provider at interview.")
        end
      end
      ...
      scenario "renders the salaried content for QTS only" do
        ...
        within('[data-qa="course__salary_details"]') do
          expect(page).to have_content("You will receive an unqualified teacher’s salary while training. The exact amount will vary depending on your school. You can discuss salary details with your provider at interview.")
        end
      end
    end
  end
