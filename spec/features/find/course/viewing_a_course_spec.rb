...
private
    ...
    @course ||= create(
      ...
      enrichments: [
        build(
          ...
          theoretical_training_location: "At the training centre",
          theoretical_training_duration: "10 weeks",
          theoretical_training_activities: "Study core pedagogy",
          assessment_methods: "Assignments and observation",
        ),
      ],
      subjects: [
        build(
  ...
  def provider
    @provider ||= create(
      ...
      about_us: "Some training with us information",
      value_proposition: "We offer excellent support",
