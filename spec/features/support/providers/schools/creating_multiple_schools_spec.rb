...
feature 'Multiple schools' do
  ...
  scenario 'feature flag off' do
    when_i_visit_a_provider_schools_page
    then_i_should_not_see_the_add_multiple_schools_link
  end
  ...
  def then_i_should_not_see_the_add_multiple_schools_link
    expect(page).not_to have_link('Add multiple schools')
  end
