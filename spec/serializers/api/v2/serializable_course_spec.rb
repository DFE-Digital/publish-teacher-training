...
describe API::V2::SerializableCourse do
  ...
  it { is_expected.to have_attribute(:accept_pending_gcse).with_value(nil) }
  it { is_expected.to have_attribute(:accept_gcse_equivalency).with_value(nil) }
  it { is_expected.to have_attribute(:accept_english_gcse_equivalency).with_value(nil) }
