...
describe API::V2::SerializableCourse do
  ...
  it { should have_attribute(:accept_pending_gcse).with_value(false) }
  it { should have_attribute(:accept_gcse_equivalency).with_value(false) }
  it { should have_attribute(:accept_english_gcse_equivalency).with_value(false) }
  it { should have_attribute(:accept_maths_gcse_equivalency).with_value(false) }
  it { should have_attribute(:accept_science_gcse_equivalency).with_value(false) }
  it { should have_attribute(:additional_gcse_equivalencies) }
