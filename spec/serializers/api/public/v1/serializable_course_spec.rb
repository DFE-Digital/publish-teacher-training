...
RSpec.describe API::Public::V1::SerializableCourse do
  ...
  it { is_expected.to have_attribute(:bursary_requirements).with_value(CourseFunding::View.new(CourseFunding.new(course)).bursary_requirements) }
  ...
  it { is_expected.to have_attribute(:has_scholarship).with_value(CourseFunding.new(course).has_scholarship?) }
