...
describe CourseSerializer do
  ...
  it { is_expected.to include(course_code: course.course_code) }
  it { is_expected.to include(name: course.name) }
  it { is_expected.to include(recruitment_cycle: course.provider.recruitment_cycle.year) }
  it { is_expected.to include(created_at: course.created_at.iso8601) }
  it { is_expected.to include(changed_at: course.changed_at.iso8601) }
