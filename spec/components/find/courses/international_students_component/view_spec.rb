...
describe Find::Courses::InternationalStudentsComponent::View, type: :component do
  ...
  context 'when the course is salaried, the db_backed_funding_type is disabled and can sponsor Skilled Worker visas' do
    before do
      course = build(
        :course,
        funding_type: 'salary',
  ...
  context 'when the course is salaried, the db_backed_funding_type is enabled and can sponsor Skilled Worker visas' do
    before do
      course = build(
        :course,
        funding_type: 'salary',
  ...
  context 'when the course is salaried, the db_backed_funding_type is inactive and does not sponsor Skilled Worker visas' do
    before do
      course = build(
        :course,
        funding_type: 'salary',
  ...
  context 'when the course is salaried, the db_backed_funding_type is active and does not sponsor Skilled Worker visas' do
    before do
      course = build(
        :course,
        funding_type: 'salary',
  ...
  context 'when the course is an apprenticeship and the db_backed_funding_type feature flag is inactive' do
    before do
      course = build(
        :course,
  ...
  context 'when the course is an apprenticeship and the db_backed_funding_type feature flag is active' do
    before do
      course = build(
        :course,
        funding_type: 'apprenticeship'
