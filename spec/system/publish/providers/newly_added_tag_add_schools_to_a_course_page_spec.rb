...
RSpec.describe "Publish - Courses: 'Newly added' tag for register import sites when selecting schools", service: :publish, travel: Find::CycleTimetable.find_closes(2025) do
