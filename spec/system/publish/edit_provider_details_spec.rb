...
RSpec.describe "About Your Organisation section" do
  ...
  def then_i_can_edit_info_about_training_with_us
    visit edit_publish_provider_recruitment_cycle_why_train_with_us_path(
      provider_code: @provider.provider_code,
      recruitment_cycle_year: @provider.recruitment_cycle_year,
    )
    ...
    fill_in "What kind of organisation is #{@provider.provider_name}", with: "Updated: Training with you"
    fill_in "Why should candidates choose to train with you", with: "Updated: Training with you"
    click_on "Update why train with us"
  ...
  def then_i_can_edit_info_about_disabilities_and_other_needs
    visit edit_publish_provider_recruitment_cycle_disability_support_path(
      provider_code: @provider.provider_code,
      recruitment_cycle_year: @provider.recruitment_cycle_year,
    )
