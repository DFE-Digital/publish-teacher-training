    ...
    @user = create(
      ...
      providers: [
        create(
          ...
          :accredited_provider,
          sites: [
            build(:site, location_name: "School Alpha"),
            build(:site, location_name: "School Beta"),
            build(:site, :study_site, location_name: "Study Site Alpha"),
            build(:site, :study_site, location_name: "Study Site Beta"),
          ],
        ),
      ],
    )
