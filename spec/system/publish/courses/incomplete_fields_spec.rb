...
RSpec.describe "Incomplete fields on a course", service: :publish do
  ...
  scenario "every empty field on a fee paying course description prompts the user to fill it in" do
    ...
    and_i_see_the_prompt("Enter how you decide which schools to place trainees in", "/fields/where-you-will-train#publish-fields-where-you-will-train-form-placement-selection-criteria-field")
    and_i_see_the_prompt("Enter how much time trainees will spend in each school", "/fields/where-you-will-train#publish-fields-where-you-will-train-form-duration-per-school-field")
