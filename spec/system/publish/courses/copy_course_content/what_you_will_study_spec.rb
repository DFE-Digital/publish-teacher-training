...
RSpec.describe "Copy course content - what you will study", service: :publish do
  ...
  def and_all_the_copy_course_links_work
    click_link "What will trainees do during their theoretical training?"
    expect(find_field("What will trainees do during their theoretical training?")).to be_visible
    scroll_to :top

    click_link "How will they be assessed?"
    expect(find_field("How will they be assessed? (optional)")).to be_visible
  end

  def and_i_click_the_change_link
    click_link "Change details about what you will study"
  end
  ...
  def then_i_see_the_copied_content_in_the_current_course
    expect(find_field("What will trainees do during their theoretical training?").value).to eq "Banana"
    expect(find_field("How will they be assessed? (optional)").value).to eq "Apple"
  end
