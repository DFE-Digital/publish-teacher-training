...
RSpec.describe "Search Results on small viewport", :js, service: :find do
  ...
  after do
    when_i_resize_to_large_viewport
  end

  scenario "I filter by visa sponsorship" do
    given_there_are_courses_that_sponsor_visa
    and_there_are_courses_that_do_not_sponsor_visa
    when_i_visit_the_find_results_page

    then_i_cannot_see_the_filter_and_sort_disclosure
    when_i_resize_to_small_viewport
    then_i_can_see_the_filter_and_sort_disclosure
    and_i_cannot_see_the_filter_disclosures
    when_i_click_the_filter_and_sort_button
    then_i_can_see_the_filter_disclosures
  ...
  def then_i_cannot_see_the_filter_and_sort_disclosure
    expect(page).to have_no_content("Filter and Sort")
  end

  def when_i_resize_to_small_viewport
    page.current_window.resize_to(300, 1200)
  end

  def when_i_resize_to_large_viewport
    page.current_window.resize_to(1400, 1400)
  end

  def then_i_can_see_the_filter_and_sort_disclosure
    expect(page).to have_content("Filter and Sort")
  end
