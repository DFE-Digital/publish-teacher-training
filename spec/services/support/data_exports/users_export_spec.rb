      ...
      expect(res).to eql(
        {
          ...
          sign_in_user_id: user.authentications.dfe_signin.first&.subject_key,
        },
      )
    end
  end
      ...
      expect(res).to eql([
        {
          ...
          sign_in_user_id: user1.authentications.dfe_signin.first&.subject_key,
        },
        {
          user_id: user2.id,
          ...
          sign_in_user_id: user2.authentications.dfe_signin.first&.subject_key,
        },
      ])
    end
  end
