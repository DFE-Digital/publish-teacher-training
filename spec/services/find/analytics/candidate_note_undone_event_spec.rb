...
RSpec.describe Find::Analytics::CandidateNoteUndoneEvent do
  subject do
  ...
  describe "#event_name" do
    it "returns :candidate_note_undone" do
      expect(subject.event_name).to eq(:candidate_note_undone)
    end
  end
