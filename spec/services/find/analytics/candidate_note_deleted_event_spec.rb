...
RSpec.describe Find::Analytics::CandidateNoteDeletedEvent do
  subject do
  ...
  describe "#event_name" do
    it "returns :candidate_note_deleted" do
      expect(subject.event_name).to eq(:candidate_note_deleted)
    end
  end
