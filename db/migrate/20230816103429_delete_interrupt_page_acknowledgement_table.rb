...
class DeleteInterruptPageAcknowledgementTable < ActiveRecord::Migration[7.0]
  def change
    drop_table :interrupt_page_acknowledgement do |t|
      ...
      t.index %w[recruitment_cycle_id], name: "index_interrupt_page_acknowledgement_on_recruitment_cycle_id"
      t.index %w[user_id], name: "index_interrupt_page_acknowledgement_on_user_id"
    end
  end
end
