...
class ValidateAddForeignKeysToSolidQueueTables < ActiveRecord::Migration[8.1]
  def change
    validate_foreign_key :solid_queue_batch_executions, :solid_queue_batches
    validate_foreign_key :solid_queue_batch_executions, :solid_queue_jobs
