...
ActiveRecord::Schema[8.1].define(version: 2026_03_16_174500) do
  ...
  add_foreign_key "course_enrichment", "user", column: "created_by_user_id", name: "FK_course_enrichment_user_created_by_user_id", on_delete: :nullify
  add_foreign_key "course_enrichment", "user", column: "updated_by_user_id", name: "FK_course_enrichment_user_updated_by_user_id", on_delete: :nullify
  ...
  add_foreign_key "organisation_user", "user", name: "FK_organisation_user_user_user_id", on_delete: :cascade
  ...
  add_foreign_key "providers_onboarding_form_request", "user", column: "support_agent_id", name: "FK_onboarding_request_user_support_agent_id", on_delete: :nullify
  ...
  add_foreign_key "user_notification", "user", on_delete: :cascade
  add_foreign_key "user_permission", "provider"
  add_foreign_key "user_permission", "user", on_delete: :cascade
end
