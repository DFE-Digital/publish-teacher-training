    ...
    private
      ...
      def form_params
        params
          ...
          .permit(:age_group, :c, :fulltime, :has_vacancies, :l, :lat, :lng, :loc, :lq, :parttime, :rad, :senCourses, :sortby, :prev_l, :prev_lat, :prev_lng, :prev_loc, :prev_lq, :prev_query, :prev_rad, :query, :degree_required, :can_sponsor_visa, :funding, subject_codes: [], qualification: [])
      end
