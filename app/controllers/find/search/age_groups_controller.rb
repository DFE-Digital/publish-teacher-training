    ...
    private
      ...
      def form_params
        params
          ...
          .permit(:age_group, :c, :has_vacancies, :l, :latitude, :lng, :loc, :lq, :rad, :send_courses, :sortby, :prev_l, :prev_lat, :prev_lng, :prev_loc, :prev_lq, :prev_query, :prev_rad, "provider.provider_name", :degree_required, :can_sponsor_visa, :funding, subjects: [], qualification: [], study_type: [])
      end
