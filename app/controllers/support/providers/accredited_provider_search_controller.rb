  ...
  module Providers
    ...
    private
      ...
      def accredited_provider_id
        params[:accredited_provider_id] || accredited_provider_select_params[:provider_id]
      end
      ...
      def accredited_provider_search_params
        ...
        params.expect(accredited_provider_search_form: [*AccreditedProviderSearchForm::FIELDS, :accredited_provider_id])
      end
      ...
      def redirect_to_next_step
        redirect_to check_support_recruitment_cycle_provider_accredited_partnerships_path(accredited_provider_id:)
      end
    end
  end
end
