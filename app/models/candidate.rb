class Candidate < ApplicationRecord
  ...
  has_many :recent_searches, class_name: "::RecentSearch", foreign_key: :find_candidate_id, inverse_of: :find_candidate, dependent: :destroy
  has_many :email_alerts, class_name: "Candidate::EmailAlert", dependent: :destroy
