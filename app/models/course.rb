...
class Course < ApplicationRecord
  ...
  def accredited_body_exists_in_current_cycle
    ...
    errors.add(:base, "The Accredited provider #{accredited_body_code} does not exist in this cycle") unless RecruitmentCycle.current.providers.find_by(provider_code: accredited_body_code)
  end
end
