...
class Course < ApplicationRecord
  ...
  def set_first_published_datetime
    return if first_published_datetime.present?

    update_column(:first_published_datetime, publication_datetime_for_first_publish)
  end
