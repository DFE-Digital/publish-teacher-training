  ...
  def enrichment_error_url(provider_code:, course:, field:, message: nil)
    ...
    if field.to_sym == :base
...

      {
        ...
        placement_selection_criteria: "#{field_base_url}/where-you-will-train?display_errors=true#publish-fields-where-you-will-train-form-placement-selection-criteria-field-error",
        duration_per_school: "#{field_base_url}/where-you-will-train?display_errors=true#publish-fields-where-you-will-train-form-duration-per-school-field-error",
