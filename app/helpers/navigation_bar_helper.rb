...
module NavigationBarHelper
  ...
  if FeatureService.enabled?(:accredited_provider_search)
    ...
    def navigation_items(provider)
      [
        ...
        *([name: t('navigation_bar.accredited_provider'), url: publish_provider_recruitment_cycle_accredited_providers_path(provider.provider_code, provider.recruitment_cycle_year)] if provider.provider_type == 'lead_school'),
