...
class ALevelSubjectRequirementRowComponent < ViewComponent::Base
  ...
  def grade_hint
    if minimum_grade?
      "#{I18n.t('course.a_levels_wizard/steps/a_level_equivalencies.or_above')} #{I18n.t('course.a_levels_wizard/steps/a_level_equivalencies.suffix')}"
    else
      I18n.t("course.a_levels_wizard/steps/a_level_equivalencies.suffix")
    end
  end
