...
class ALevelRowComponent < ViewComponent::Base
  ...
  def pending_a_level_summary_content
    I18n.t("course.a_levels_wizard/steps/consider_pending_a_level.row.#{@course.accept_pending_a_level?}") unless @course.accept_pending_a_level.nil?
  end

  def a_level_equivalency_summary_content
    I18n.t("course.a_levels_wizard/steps/a_level_equivalencies.row.#{@course.accept_a_level_equivalency?}") unless @course.accept_a_level_equivalency.nil?
  end
