...
module Publish
  class WhyTrainWithUsForm < BaseProviderForm
    ...
    validates :provider_value_proposition, presence: { message: "Enter details about training with you" }, if: :provider_value_proposition_changed?
    validates :about_us, presence: { message: "Enter details about your organisation" }, if: :about_us_changed?

    validates :provider_value_proposition, words_count: { maximum: 100, message: "Reduce the word count for your value proposition" }
  ...
  private
    ...
    def provider_value_proposition_changed?
      changed?(:provider_value_proposition)
    end
