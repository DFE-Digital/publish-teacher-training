...
module Publish
  # The filters on the publish course list. Modelled on Courses::SearchForm (the
  # Find search form) but deliberately separate: none of that form's subject,
  # provider or location machinery applies here.
  #
  ...
  class CourseFilterForm < ApplicationForm
