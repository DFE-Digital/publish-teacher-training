  ...
  resources :providers, path: "organisations", param: :code, only: [:show] do
    ...
    resources :recruitment_cycles, param: :year, constraints: CycleYearConstraint.new, path: "", only: [:show] do
      ...
      resources :courses, param: :code, only: %i[index new create show] do
        ...
        get "/a-levels-or-equivalency-tests/add-a-level-to-a-list", to: "courses/a_level_requirements/add_a_level_to_a_list#new", as: :a_levels_add_a_level_to_a_list
        post "/a-levels-or-equivalency-tests/add-a-level-to-a-list", to: "courses/a_level_requirements/add_a_level_to_a_list#create"
      ...
      scope module: :providers do
        ...
        resources :schools, only: %i[index create show destroy] do
          member do
            ...
            get "remove-course/:course_code", to: "schools/remove_courses#show", as: :remove_course
            delete "remove-course/:course_code", to: "schools/remove_courses#destroy"
          end
