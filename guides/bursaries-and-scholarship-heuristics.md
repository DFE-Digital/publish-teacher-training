...
## 6. Modern Languages (Scholarship Special Case)

Modern Languages courses are generated with the format *Modern languages (X)*, *Modern languages (X and Y)*, or *Modern languages (X, Y, Z)* — where X, Y, and Z are the individual named languages (e.g., *Modern languages (French and German)*, *Modern languages (Spanish, Mandarin, Italian)*). Unlike other subjects, scholarship eligibility for Modern Languages is determined by **every** named language inside the brackets, not just the first.

### Rule:

- A Modern Languages course is eligible for a scholarship **only if all named languages listed within the brackets are individually scholarship‑eligible**.
- If **any** named language is not scholarship‑eligible, the course does **not** qualify for a scholarship — even if the other languages would otherwise be eligible on their own.

### Examples:

- *Modern languages (French and German)* → Scholarship applies only if **both** French and German are scholarship‑eligible in the current cycle.
- *Modern languages (Spanish, Mandarin, Italian)* → No scholarship if any one of Spanish, Mandarin, or Italian is not scholarship‑eligible, even if the others are.
- *Modern languages (French)* → Scholarship applies if French is scholarship‑eligible.

Note: this rule applies to **scholarship** eligibility only. Bursary eligibility for Modern Languages continues to follow the primary‑subject rule in Section 4.

---

## 7. Summary of Implementation Logic
...
5. For Modern Languages scholarship eligibility, require **every** named language to be individually scholarship‑eligible; otherwise withhold the scholarship.
6. Ignore supporting subjects for bursary calculation; the service cannot infer a 50/50 split.
7. Display bursary/scholarship accordingly.
