...
RUN apk add --no-cache ncurses=6.3_p20211120-r2 ncurses-libs=6.3_p20211120-r2 libcurl=8.2.1-r0 libcrypto1.1=1.1.1u-r2 pkgconf=1.8.1-r0 nghttp2=1.46.0-r1
